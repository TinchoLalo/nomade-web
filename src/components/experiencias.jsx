                ...
                <div className="mt-20 w-full min-h-screens mmd:w-full mmd:p-10 relative overflow-hidden">
                    ...
                    <div className="flex flex-col mmd:flex-row justify-center text-center mx-auto items-center mb-20">
                        ...
                        <div className="w-full mmd:w-2/4 text-left mt-20 text-1 mx-auto ml-40 2xl:ml-20 md:mx-auto md:mt-80 md:pt-4">
                            <h3 className="text-6xl font-semibold md:text-4xl md:text-center">Diseñamos <br />experiencias<br /> de <b>aprendizaje</b></h3>
                            
                            <p className="text-1 text-xl w-[70%] mt-8 md:mx-auto md:text-justify md:w-[90%]">para que tu organización enfrente los desafíos del futuro laboral a través de la innovación educativa impactando en equipos y comunidades</p>

                            <a href="#metodo" className="text-2xl mt-16 mx-auto text-center bg-amber-300 rounded-full py-4 px-8 inline-block text-amber-300 text-white font-semibold md:text-lg md:px-4 md:mx-10 md:mt-10">
                            NUESTRA METODOLOGÍA
                            </a>
                        </div>
