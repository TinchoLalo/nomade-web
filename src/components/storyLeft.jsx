            ...
            <section id="experiencias" className="w-screen flex ">
                <div className="mt-2 w-full  mmd:w-full p-10 relative overflow-hidden">
                    ...
                    <div className="duration-200 flex flex-col mmd:flex-row justify-center text-center mx-auto items-center mb-2">
                        ...
                        <div className="duration-200 w-full mmd:w-3/4 text-left mt-20 text-1 mx-auto ml-40 2xl:ml-20 md:mx-auto md:mt-60">
                            <h4 className="text-3xl md:text-2xl md:text-center mmd:w-[50%] italic mb-4">{frase}</h4>
                            <h3 className="text-6xl font-semibold md:text-3xl md:text-center mmd:w-[50%]">{title}</h3>

                            <p className="text-1 text-xl w-[50%] mt-8 md:mx-auto md:text-justify md:w-full">{description}</p>

                            <a href={url}>
                                <button className="mx-4 text-2xl mt-16 mx-auto text-center bg-amber-300 rounded-full py-4 px-8 inline-block text-white font-semibold md:text-lg md:mx-2 md:px-2">
                                    {button}
                                </button>
                            </a>
                        </div>
                        ...
                        <motion.img
                            ...
                            variants={fadeInUp}
                            className="w-[35%] z-20 absolute right-[5rem] 2xl:mt-20 md:top-[-5rem] md:w-[75%] md:right-auto md:left-auto"
                        />
                    </div>
