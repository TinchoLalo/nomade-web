    ...
    return (
        <>  
            <section id="soluciones" className="w-screen flex">
                <div className="mt-20 2xl:mt-20 w-full min-h-screens mmd:w-full p-10 relative overflow-hidden" ref={ref}>
                    <div className="justify-center text-center mx-auto items-center mmd:flex 2xl:mb-20">
                        ...
                        >
                            ...
                            <p className="text-1 text-xl w-[90%] mt-8 md:mx-auto md:text-left md:w-full">
                        ...
                        >
                            <div className="w-full mmd:w-[95%] h-auto mmd:rounded-l-full p-6 bg-color3 mmd:flex items-center md:rounded-3xl md:mt-20 fade-in slide-in-right">
                                ...
                                <div className="mmd:ml-16 md:mt-6">
                                    ...
                                    <a href="/company" className="mt-4 text-sm font-medium text-black hover:underline">Quiero más info →</a>
                                </div>
                            </div>
                            ...
                            <div className="w-full mmd:w-[95%] mt-10 h-auto mmd:rounded-l-full p-6 bg-color3 mmd:flex items-center md:rounded-3xl md:mt-20 z-20 fade-in slide-in-right">
                                ...
                                <div className="mmd:ml-16 md:mt-6">
                                    ...
                                    <a href="/education" className="mt-4 text-sm font-medium text-black hover:underline">Quiero más info →</a>
                                </div>
                            </div>
                        </motion.div>

                        <img src={forma1} alt="forma" className="w-[65%] z-10 absolute bottom-[-38rem] left-[-35rem] origin-left opacity-[.4] 2xl:bottom-[-28rem] md:left-[-10rem] md:top-[-6rem] md:rotate-45" />
                    </div>
                </div>
            </section>
        </>
